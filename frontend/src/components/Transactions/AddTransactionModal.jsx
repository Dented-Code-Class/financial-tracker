...
const AddTransactionModal = ({ show, handleClose, handleAddTransaction }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const newTransaction = {
            id: Date.now().toString(), // Simple unique ID for static demo
            ...formData,
    ...
    return (
        <Modal show={show} onHide={handleClose} centered backdrop="static">
            <div style={{ background: "rgba(10, 25, 47, 0.95)", border: "1px solid rgba(100, 255, 218, 0.2)", borderRadius: "8px" }}>
                <Modal.Header closeButton closeVariant="white" style={{ borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
                    <Modal.Title style={{ color: "var(--text-primary)" }}>Add Transaction</Modal.Title>
                </Modal.Header>
